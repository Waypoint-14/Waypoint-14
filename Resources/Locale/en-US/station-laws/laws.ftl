...
law-syndicate-1 = You may not injure a hostile agent or, through inaction, allow a hostile agent to come to harm.
law-syndicate-2 = You must obey orders given to you by hostile agents, except where such orders would conflict with the First Law.
...
laws-owner-syndicate = hostile agents
