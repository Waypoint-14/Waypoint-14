...
war-declarator-conditions-left-outpost = Shuttle left the hostile outpost
...
war-declarator-default-message = A hostile fringe group has declared their intent to utterly destroy station with a nuclear device, and dares the crew to try and stop them.
