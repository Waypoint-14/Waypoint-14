...
nukeops-welcome =
    ...
    Operation {$name} is a go ! Death to the Corporate Coalition!

nukeops-opsmajor = [color=crimson]Hostile major victory![/color]
nukeops-opsminor = [color=crimson]Hostile minor victory![/color]
...
nukeops-cond-nukeactiveatcentcom = The nuclear bomb was delivered to Corporate Coalition Headquarters!
