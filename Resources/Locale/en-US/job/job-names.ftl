...
job-name-doctor = Specialist Doctor
...
job-name-engineer = Maintenance Technician
job-name-atmostech = Atmospheric Technician
job-name-hop = Resource Coordinator
...
JobCentralCommandOfficial = Corporate Representative
...
JobHeadOfPersonnel = Resource Coordinator
JobHeadOfSecurity = Head of Security
JobJanitor = Janitor
JobLawyer = Lawyer
JobLibrarian = Librarian
JobMedicalDoctor = Specialist Doctor
...
JobStationEngineer = Maintenance Technician
