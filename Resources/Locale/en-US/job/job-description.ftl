...
job-description-borg = Half-human, Half-machine. Follow your laws, serve the crew, and hound the engineering team for upgrades.
...
job-description-ce = Manage the maintenance department to ensure power, atmospherics, and the hull are in perfect shape.
job-description-centcomoff = Act as a representative of a mega-Corporation to Waypoint-14.
job-description-chaplain = Preach the good word of the Oracle, and conduct spiritual healing and miracles with your bible.
...
job-description-cmo = Manage the resources and personnel of the medical department to keep the crew and any visitors in good health.
...
job-description-doctor = Treat the sick and wounded through the use of advanced chemicals.
job-description-engineer = Keep the station's main engine & solars active, clean the station and repair or maintain anything needed by the crew.
...
job-description-hop = Handle access reassignment fairly using your ID console, manage the Cargo department, and keep Independent Contractors up to standard.
job-description-hos = Manage your security force, keep the crew safe; and carry out any searches on visiting vessels.
job-description-intern = Administer medicine, perform triage, take care of the morgue.
...
job-description-librarian = Run the library. Act as an interpreter when needed.
...
job-description-rd = Manage the Science department, offload any artifacts or anomalous entities from any passing vessels.
